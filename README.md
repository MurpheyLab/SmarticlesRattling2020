...
The Settings for the base Xbee (connected to the computer) and the remote Xbees (on the smarticle) can be loaded from configuration profiles found in Firmware/Xbee folder.  
